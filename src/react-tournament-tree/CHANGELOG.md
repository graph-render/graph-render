...
* **@graph-render/core:** upgraded to 1.6.0
* **@graph-render/react:** upgraded to 1.7.0
* **@graph-render/types:** upgraded to 1.6.0

## @graph-render/tournament-tree 1.8.0 (2026-05-26)
...
- **@graph-render/core:** upgraded to 1.5.0
- **@graph-render/react:** upgraded to 1.6.0
...
- **@graph-render/core:** upgraded to 1.3.7
- **@graph-render/react:** upgraded to 1.4.7
- **@graph-render/types:** upgraded to 1.3.0

## <small>1.5.6 (2026-05-21)</small>
...
- **@graph-render/core:** upgraded to 1.3.6
- **@graph-render/react:** upgraded to 1.4.6
